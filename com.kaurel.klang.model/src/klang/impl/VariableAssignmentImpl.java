...
public class VariableAssignmentImpl extends StatementImpl implements VariableAssignment {
	...
	protected EClass eStaticClass() {
		return KlangPackage.Literals.VARIABLE_ASSIGNMENT;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KlangPackage.VARIABLE_ASSIGNMENT__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KlangPackage.VARIABLE_ASSIGNMENT__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KlangPackage.VARIABLE_ASSIGNMENT__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KlangPackage.VARIABLE_ASSIGNMENT__EXPRESSION, newExpression, newExpression));
	}
