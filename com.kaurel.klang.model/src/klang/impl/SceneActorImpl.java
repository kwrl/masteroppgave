 ...
 * </p>
 * <ul>
 *   <li>{@link klang.impl.SceneActorImpl#getProgram <em>Program</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SceneActorImpl extends AbstractActorImpl<SpriteActor> implements SceneActor {
	...
	public Program getProgram() {
		if (eContainerFeatureID() != KlangPackage.SCENE_ACTOR__PROGRAM) return null;
	...
	public NotificationChain basicSetProgram(Program newProgram, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newProgram, KlangPackage.SCENE_ACTOR__PROGRAM, msgs);
		return msgs;
	}
	...
	public void setProgram(Program newProgram) {
		if (newProgram != eInternalContainer() || (eContainerFeatureID() != KlangPackage.SCENE_ACTOR__PROGRAM && newProgram != null)) {
			...
			if (newProgram != null)
				msgs = ((InternalEObject)newProgram).eInverseAdd(this, KlangPackage.PROGRAM__SCENE_ACTOR, Program.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KlangPackage.SCENE_ACTOR__PROGRAM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case KlangPackage.SCENE_ACTOR__PROGRAM:
				return eInternalContainer().eInverseRemove(this, KlangPackage.PROGRAM__SCENE_ACTOR, Program.class, msgs);
		}
