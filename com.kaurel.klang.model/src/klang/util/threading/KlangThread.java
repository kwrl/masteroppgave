...
import klang.util.expressions.KlangExpressionEvaluator;
import klang.util.expressions.KlangExpressionEvaluatorImpl;
...
public class KlangThread extends KlangSwitch<Object> {
	...
	public ThreadStatus run() {
		ThreadStatus status;
		while ((status = step()) instanceof RunningStatus)
			;
	...
	@Override
	public Object caseForeverLoop(ForeverLoop object) {
		queue.addFirst(KlangFactory.eINSTANCE.createYield());
