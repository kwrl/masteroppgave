...
/**
 * This is the item provider adapter for a {@link klangexpr.VariableReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableReferenceItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableReference_variableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableReference_variableName_feature", "_UI_VariableReference_type"),
				 KlangexprPackage.Literals.VARIABLE_REFERENCE__VARIABLE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((VariableReference)object).getVariableName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariableReference.class)) {
			case KlangexprPackage.VARIABLE_REFERENCE__VARIABLE_NAME:
