...
/**
 * This is the item provider adapter for a {@link klang.VariableRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableRefItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableRef_variableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableRef_variableName_feature", "_UI_VariableRef_type"),
				 KlangPackage.Literals.VARIABLE_REF__VARIABLE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((VariableRef)object).getVariableName();
		return label == null || label.length() == 0 ?
			getString("_UI_VariableRef_type") :
