...
/**
 * This is the item provider adapter for a {@link klang.VariableReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableReferenceItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KlangPackage.Literals.VARIABLE_REFERENCE__VARIABLE_NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariableReference.class)) {
			case KlangPackage.VARIABLE_REFERENCE__VARIABLE_NAME:
