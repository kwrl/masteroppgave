...
/**
 * This is the item provider adapter for a {@link klang.GameDef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GameDefItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KlangPackage.Literals.GAME_DEF__VARIABLES);
			childrenFeatures.add(KlangPackage.Literals.GAME_DEF__ACTOR_DEFS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KlangPackage.Literals.GAME_DEF__VARIABLES,
				 KlangFactory.eINSTANCE.createVariable()));

		newChildDescriptors.add
			(createChildParameter
				(KlangPackage.Literals.GAME_DEF__ACTOR_DEFS,
				 KlangFactory.eINSTANCE.createSpriteDef()));
	}
